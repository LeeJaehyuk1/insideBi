    ...
    return (
      <ResponsiveContainer width="100%" height={H}>
        <PieChart>
          ...
          <Tooltip formatter={((v: number) => [formatKRW(v)]) as any} />
          <Legend formatter={(v) => <span style={{ fontSize: 11 }}>{v}</span>} />
        </PieChart>
      </ResponsiveContainer>
    );
  ...
  return (
    <ResponsiveContainer width="100%" height={H}>
      <BarChart data={data} margin={{ top: 8, right: 16, left: 0, bottom: 0 }}>
        ...
        <Tooltip formatter={((v: number) => [`${v}조원`]) as any} />
  ...
  return (
    <ResponsiveContainer width="100%" height={H}>
      <PieChart>
        ...
        <Tooltip formatter={((v: number) => [formatKRW(v), "익스포저"]) as any} />
    ...
    return (
      <ResponsiveContainer width="100%" height={H}>
        <BarChart data={data} margin={{ top: 8, right: 16, left: 0, bottom: 0 }}>
          ...
          <Tooltip formatter={((v: number) => [`${v.toLocaleString()}억`]) as any} />
  ...
  return (
    <ResponsiveContainer width="100%" height={H}>
      <RadarChart data={rawData} cx="50%" cy="50%" outerRadius="70%">
        ...
        <Tooltip formatter={((v: number) => [`${v}점`, "민감도"]) as any} />
      </RadarChart>
    </ResponsiveContainer>
  );
}
  ...
  return (
    <ResponsiveContainer width="100%" height={H}>
      <BarChart data={rawData} margin={{ top: 8, right: 16, left: 10, bottom: 0 }}>
        ...
        <YAxis tick={{ fontSize: 11 }} unit="억" />
        <Tooltip formatter={((v: number) => [formatKRW(Math.abs(v))]) as any} />
  ...
  return (
    <ResponsiveContainer width="100%" height={H}>
      <PieChart>
        ...
        <Tooltip formatter={((v: number) => [formatKRW(v), "금액"]) as any} />
        <Legend layout="vertical" align="right" verticalAlign="middle"
          formatter={(v) => <span style={{ fontSize: 10 }}>{v}</span>} />
      </PieChart>
    </ResponsiveContainer>
