...
export const DB_TABLES: Record<string, TableInfo[]> = {
  railway: [
    ...
    { tableId: "td_dmaqfx",        label: "Td Dmaqfx",        datasetId: "td_dmaqfx" },
    { tableId: "td_dmaqindex",     label: "Td Dmaqindex",     datasetId: "td_dmaqindex" },
    { tableId: "td_dmaqvol",       label: "Td Dmaqvol",       datasetId: "td_dmaqvol" },
...
export const TD_IRNCR_DATA: Record<string, unknown>[] = [
  makeRow("20231130",1,"S",0,10001,10001,20,10,20,20,"총위험액","시장위험액","금리위험액","일반위험액",1150000),
  makeRow("20231130",1,"S",0,10001,10001,20,10,20,30,"총위험액","시장위험액","금리위험액","금리옵션",78000),
  makeRow("20231130",1,"S",0,10001,10001,20,10,20,10,"총위험액","시장위험액","금리위험액","개별위험액",305000),
