...
import {
  Bell, Slack, Webhook, Mail, Save, RotateCcw,
    ...
    <div className="space-y-5 max-w-3xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Slack, 이메일, 웹훅으로 시스템 이벤트 알림을 받습니다</p>
        </div>
      ...
      <Card icon={Slack} title="Slack" description="Slack 채널로 알림 전송">
        ...
        {s.slackEnabled && (
          <div className="mt-4 space-y-3 pt-4 border-t border-border">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => test("slack", setTestSlack, !!s.slackWebhook)}
